...
```{r, echo = FALSE}
htmltools::HTML('<p><a href = "https://www.google.co.uk/search?q=is+coffee+the+second+most+traded+commodity+in+the+world" target = "_blank"><img src = "/img/google-being-helpful.png" alt = "google-being-helpful"></a></p>')
```
<!-- [![Google-being-helpful](/img/google-being-helpful.png)](https://www.google.co.uk/search?q=is+coffee+the+second+most+traded+commodity+in+the+world) -->
...
```{r, include=FALSE}
# Read in data from csv (for now, update function later)
...
plot_ly(allComsGroup %>% 
        ...
        hoverinfo = "text", marker = list(color = c(rep("#619fb5", 10),
                                                    "#ef8066",
                                                    rep("#619fb5", 8)))) %>% 
...
One permutation of this factoid is that coffee is the second most traded commodity by developing countries, for example here in the 2016 Pact Coffee Social Impact Report. 

```{r, echo = FALSE}
htmltools::HTML('<p><a href = "https://media.pactcoffee.com/files/Pact_Social_Impact_Report_2016.pdf" target = "_blank"><img src = "/img/coffee-developing-countries.png" alt = "pact-coffee-report"></a></p>')
```
...
Splitting the data up this way shows that coffee is relatively much more important for the low-income countries than the others, behind only gold. Out of the 30 low-income countries in the dataset, 20 are coffee producers, including high-profile origins like Ethiopia, Tanzania and Uganda. 
