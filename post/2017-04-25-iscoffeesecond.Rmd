...
allCommodities <- read_csv(file.path(coffeestats, "output/allCommodities.csv"))
...
worldMap <- readOGR(dsn = path.expand(file.path(coffeestats, "input", "worldmap", "world_shape_file")),
